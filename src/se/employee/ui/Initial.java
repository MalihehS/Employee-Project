...
public class Initial {// Database
    ...
    public static void start() {
        ...
        sF.addEmploee(new Programmer("Maliheh", "malih@gmail.com", 37, "0739031071", 4, EducationsLevel.BACHELOR, 32000.34, Gender.FEMALE));
        sF.addEmploee(new Secretor(2, "Anna", "anna@hotmail.com", 32, "0738846538", 22008.234, Gender.FEMALE));
        ...
        sF.addEmploee(new Programmer("Miriam", "Miriam@gmail.com", 43, "0739000071", 4, EducationsLevel.MASTER, 33000.34, Gender.FEMALE));
